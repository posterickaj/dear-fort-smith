---
title: "The Bailey Hill Reservoir Project Doesn’t Pencil. The Deficit Isn’t the Tax Exemption, it’s the Suburban Math"
description: "I did the math."
pubDate: 2026-06-21
heroImage: "/images/public-subsidies.png"
tags:
  - balanced-budget
  - do-the-math
  - money-ball
...
If the impetus for the complaint is that “some people receive benefits, while others do not,” do we know that to be the case? 

Streets are funded by a .625% sales tax. The residents of Bailey Hill Reservoir are not exempt from sales tax. 
...
![Spreadsheet showing Bailey Hill infrastructure cost and projected revenue math](/images/does-it-pencil.png)

We can expect each unit to lose the city $89/month. But can we make it pencil out? Where can we pick up an extra $89? What would it take?  It would take a development pattern that produces more value per foot of infrastructure. That means either (1) adding value, or (2) reducing infrastructure. 

We can add value to the Bailey Hill Reservoir project by allowing neighborhood retail, generating sales tax: a small grocery, coffee shop, daycare, barber, pharmacy, or corner store. Add a few more homes on the same infrastructure footprint. Allow small mixed-use buildings. All of these strategies increase tax revenue without costing any additional money.

Reducing infrastructure is as simple as designing the neighborhood for walkability. Walking means at least some streets are smaller, some intersections are smaller, and there is less asphalt needing maintenance overall. Impervious surfaces lead to drainage issues, so this saves on drainage as well. Then avoid hierarchical networks in favor of a hexagonal grid, dispersing traffic equally, which further contributes to walkability and removes demand for wider streets.

Do all of these, and the math changes. Instead of low-productivity sub-urban form, the profitable neighborhood is one that is lively, livable, and walkable. 

None of this means Bailey Hill is a bad project. Affordable homeownership may be a legitimate public goal even when the spreadsheet does not produce a clean fiscal surplus. Cities do not exist only to maximize revenue. But if we are going to subsidize a project for a public purpose, we should name the subsidy honestly, measure it honestly, and then ask whether the design could produce more public value for the same public cost.

Do not tell me affordable housing is uniquely irresponsible while ignoring the millions of dollars we spend maintaining our own low-productivity streets, drainage, pipes, and public services. Very few people actually pay their own way.
The scandal is not that Bailey Hill receives a subsidy. The scandal is that Fort Smith only notices subsidies when the beneficiaries are poor.
